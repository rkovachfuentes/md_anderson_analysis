...
print("ch1 mean signal area")
print(ch1_mean_signal_areas)
split_mean_signal_areas = np.split(ch1_mean_signal_areas,split_idx,axis=0)
for i in range(0,len(split_pulses)-1):
    print("x", split_doses[i])
    print("y", split_mean_signal_areas[i])
