...
class ScopeViewApp(ttk.Frame):  # Changed base class to ttk.Frame
    ...
    def on_select(self, xmin, xmax):
        ...
        self.bins_around = int(self.entry_baseline_bins_around.get())
        self.update_plot(self.plot_selector.get(), xmin, xmax, self.baseline_offset, bins_around)
    ...
    def entry_baseline_changed(self, event):
        ...
        self.baseline_offset = self.entry_baseline_offset.get()
        self.bins_around = int(self.entry_baseline_bins_around.get())
        self.update_plot(self.plot_selector.get(), start_time, end_time, self.baseline_offset, self.bins_around)
    ...
    def load_files(self):
        ...
        for index, row in filtered_df.iterrows():
           ...
           for file in files:
               ...
               #nPeaks = len(self.parent.analysis.peaks_below)
                ...
                try:
                    ...
                    for group_name, group_df in grouped_data:
                        ...
                        if len(group_df[x_col].unique()) > 0:
                            ...
                            line, = self.ax.plot(average_df[x_col], average_df[y_col], label=group_name, linestyle='-')
